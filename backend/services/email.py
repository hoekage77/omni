...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'dom@agentx.ai')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Agent X Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Agent X — Let's Get Started "
...
<head>
  ...
  <title>Welcome to Agent X</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/agent-x-logo.png" alt="Agent X Logo" class="logo">
    </div>
    <h1>Welcome to Agent X!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Agent X — we're excited to have you on board!</strong></em></p>
    ...
    <p><strong>For your business:</strong> if you want to automate manual and ordinary tasks for your company, book a call with us <a href="https://cal.com/team/agentx/enterprise-demo">here</a></p>

    <p>Thanks again, and welcome to the Agent X community <span class="emoji">🌞</span></p>

    <p>— The Agent X Team</p>

    <a href="https://www.agentx.so/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Agent X — we're excited to have you on board!
...
For your business: if you want to automate manual and ordinary tasks for your company, book a call with us here: https://cal.com/team/agentx/enterprise-demo 

Thanks again, and welcome to the Agent X community 🌞

— The Agent X Team

Go to the platform: https://www.agentx.so/

---
© 2024 Agent X. All rights reserved.
You received this email because you signed up for an Agent X account."""
