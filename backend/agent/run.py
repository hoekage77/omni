...
async def run_agent(
    ...
    # If no agent config (enabled_tools is None), register ALL tools for full Agent X capabilities
    ...
    if enabled_tools is None:
        # No agent specified - register ALL tools for full Agent X experience
        logger.info("No agent specified - registering all tools for full Agent X capabilities")
