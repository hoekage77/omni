...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Agent X',
    description: 'Replay this Agent conversation on Agent X',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Agent X';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Agent X';
